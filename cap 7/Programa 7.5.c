...
gets(cad0);
i = atoi(cad0);
/*La funcion atoi convierte una cadena de caracteres que contiene n�meros
a un valor de tipo enter. Si la cadena comienza con otro caracter o no
...
gets(cad0);
d = atof(cad0);
/*La funcion atof convierte una cadena de caracteres que contiene n�meros
reales a un valor de tipo double. Si la cadena comienza con otro caracter
o no contiene numeros, regresas 0 o el valor queda indefinido. */
printf("\n%s \t %.2lf ", cad0, d+1.50);

d = strtod(cad0, &cad1);
/* La funcion strtod convierte una cadena de caracteres que contiene n�meros
