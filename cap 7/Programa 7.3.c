...
void main(void)
{
char *cad0 = "Buenos dias";  /*En este caso se asignan 11 caracteres m�s el
caractere de terminaci�n '\0' a la posici�n de memoria a la que apunta la
variable cad0 -apuntador del tipo cadena de caracteres. */

char cad1[20] = "Hola";     /*Se asignan cuatro caracteres m�s el caractere
de terminaci�n a la variable tipo char cad1. Observa que cad1 tiene espacio
para 20 caracteres. */

char cad2[] = "Mexico";    /*En este caso se asignan seis caracteres (m�s
el carcter de terminaci�n) a la variable cad2. Observa que cad2 no tiene espacio
