...
como la forma de acceso a los campos de las variables o apuntadores de tipo estructura, tanto para lectura como para escritura. Se utiliza además una
...
struct empleado  /*Declaración de la estructura anidada empleado. */
{
    ...
    float sueldo; 
        domicilio direccion;       /*dirección es un campo de tipo estructura domicilio de la estructura empleado. */
};
...
/*En la función Lecgura se leen los campos de una variable, e4, y un apuntador 
