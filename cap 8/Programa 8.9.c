...
de bienes raíces d ela ciudad de lIma, pErú, tanto para venta como para renta. */
...
void F1(propiedades *, int);             /*Prototipo de funciones. */
void F2(propiedades *, int);

void main(void)
{
    propiedades PROPIE[100];
    /*Se declara una rreglo unidimensional de tipo estructura propiedades. */
    int TAM;
    do {
...
/*Esta función se utiliza para leer una rreglo unidimensional de tipo estructura
...
disponibles para venta en la zona de Miraflroes, cuyo valor oscila entre 
