...
productos, obtiene informaci�n estadistica valiosa para la empresa. */
...
unidimensional que se utilizar� posteriormente. */
{
int I, J, SUM;
printf("\n");
for (I=0; I< F; I++)
...
{
/* Esta funcion se utiliza para calcular el monto total de ventas de la f�brica. */
int I;
float SUM = 0.0;
for (I=0; I<C; I++)
SUM += A[I];
...
/* Esta funci�n se utiliza para obtener el tipo de producto que m�s se ha vendido
