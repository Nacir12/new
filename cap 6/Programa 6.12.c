...
de precipitacion pluvial en los ultimos 10 a�os. Escribe adem�s el registro
correspondiente. */
{
int I, K, J, EMAY = -1;
float ELLU = -1.0, SUM;
...
/* Esta funci�n se utiliza para localizar la provincia que tuvo el menor registro de lluvias en el �ltimo a�o. Escribe adem�s el registro correspondiente. */
{
int I, J, EMEN;
float ELLU = 1000, SUM;
for (I=0; I<F; I++)
